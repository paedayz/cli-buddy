...
from src.rag.infrastructure.tools.math_tools import execute_math_tool_call, Add, Subtract, Multiply, Divide, Prime, Sqrt, Factorial, Fibonacci, Mode, LetterCount
...
def get_answer_from_tools_call(query: str) -> str:
    ...
    results = [execute_math_tool_call(call) for call in tool_calls]
